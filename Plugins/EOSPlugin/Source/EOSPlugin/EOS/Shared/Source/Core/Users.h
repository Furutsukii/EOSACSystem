...
struct FUserInfoQueryPayload
{
	...
	std::function<void(FUserData_EOS&)> OnUserInfoRetrievedCallback;
};
...
public:
	...
	*/
	static void QueryUserInfo(EOS_EpicAccountId TargetUserId, std::function<void(const FUserData_EOS&)> UserInfoRetrievedCallback);
	...
	* @param TargetUserId - Account ID for the user to be queried
	*/
	static void QueryUserInfo(EOS_EpicAccountId LocalUserId, EOS_EpicAccountId TargetUserId, std::function<void(const FUserData_EOS&)> UserInfoRetrievedCallback);
	...
	*/
	static void QueryUserInfo(EOS_EpicAccountId LocalUserId, const std::wstring& DisplayName, std::function<void(const FUserData_EOS&)> UserInfoRetrievedCallback);
	...
	* @param TargetUserId - Account ID for the user to be queried
	*/
	static void QueryUserInfo(EOS_EpicAccountId LocalUserId, EOS_EpicAccountId TargetUserId, const EOS_UserInfo_OnQueryUserInfoCallback CompletionDelegate, std::function<void(const FUserData_EOS&)> UserInfoRetrievedCallback);
	...
	* @param DisplayName - display name for the user to be queried
	*/
	static void QueryUserInfo(EOS_EpicAccountId LocalUserId, const std::wstring& DisplayName, const EOS_UserInfo_OnQueryUserInfoByDisplayNameCallback CompletionDelegate, std::function<void(const FUserData_EOS&)> UserInfoRetrievedCallback);
...
private:
	...
	*/
	...
	static void EOS_CALL OnQueryDisplayNameFinishedCallback(const FUserData_EOS& UserData);
