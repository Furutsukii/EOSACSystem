...
{
	/** Platform Product ID (Format: String - e.g. "-productid 318273821731232") */
	static constexpr wchar_t ProductId[] = L"productid";

	/** Platform Sandbox ID (Format: String - e.g. "-sandboxid 43438494872348974") */
	static constexpr wchar_t SandboxId[] = L"sandboxid";

	/** Platform Deployment ID (Format: String - e.g. "-deploymentid 9234923874923784") */
	static constexpr wchar_t DeploymentId[] = L"deploymentid";

	/** Platform Client ID (Format: String - e.g. "-clientid 873284732847834") */
	static constexpr wchar_t ClientId[] = L"clientid";

	/** Platform Client Secret (Format: String - e.g. "-clientsecret 8732847328478343403430494034") */
